var Docs = function(){
    ...
    return {
        init : function(){
            ...
            layout.add('west', new Ext.ContentPanel('classes', {title: '基础功能', fitToFrame:true}));
            layout.add('west', new Ext.ContentPanel('west2', {title: '业务', fitToFrame:true}));			
	        layout.getRegion('west').showPanel('classes');			
